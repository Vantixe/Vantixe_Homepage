...
export const servicePages: ServicePageData[] = [
  ...
  },
  {
    ...
    relatedServices: [
      { icon: '\uD83E\uDD16', title: 'Autonomous Sourcing', description: 'See AI-augmented procurement in action: our agents build RFQs, distribute them to suppliers, collect responses, benchmark pricing and draft negotiations.', href: 'https://vantixe.ai/sourcing-agent' },
  ...
  },
  {
    ...
    techCallout: {
      ...
      description: 'In addition to custom solutions built during consulting engagements, we have developed enterprise-grade products that are deployed and proven - including TPRM, our compliance platform, and Autonomous Sourcing and Negotiation.',
